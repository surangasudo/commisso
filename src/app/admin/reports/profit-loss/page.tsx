                    ...
                    <Tabs defaultValue="products">
                        ...
                        <TabsContent value="sub-agent" className="mt-4">
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {subAgentProfitData.map(item => (
                                        <TableRow key={item.subAgentName}>
                                            <TableCell>{item.subAgentName}</TableCell>
                                            <TableCell className="text-right">${item.profit.toFixed(2)}</TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            ...
                            <div className="flex justify-between items-center mt-4 text-sm text-muted-foreground">
                                <span>Showing 1 to {subAgentProfitData.length} of {subAgentProfitData.length} entries</span>
                                <div className="flex items-center gap-1">
                                    <Button variant="outline" size="sm">Previous</Button>
                                    <Button variant="default" size="sm" className="w-8 h-8 p-0">1</Button>
                                    <Button variant="outline" size="sm">Next</Button>
