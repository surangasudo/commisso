                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={formData.expenseFor} onValueChange={(value) => handleSelectChange('expenseFor', value)}><SelectTrigger id="expenseFor"><SelectValue placeholder="None" /></SelectTrigger><SelectContent><SelectItem value="none">None</SelectItem></SelectContent></Select>
                            </div>
                             <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                             ...
                             <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2 border rounded-md px-3 h-10 text-sm bg-slate-100 cursor-not-allowed">
                                    ...
                                    <span>{format(formData.date, 'MM/dd/yyyy HH:mm')}</span>
                                </div>
                            </div>
                            <div className="space-y-2 h-[4.7rem]">
                                {/* Spacer div to align with referenceNo's description */}
                            </div>
                            <div className="space-y-2">
