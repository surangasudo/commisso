...
export default function AddQuotationPage() {
    ...
    const subtotal = quotationItems.reduce((acc, item) => acc + calculateSubtotal(item), 0);
    ...
    const handleSaveQuotation = () => {
        ...
        console.log("Saving quotation:", quotationItems);
        toast({
            title: "Success!",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="quotation-no" placeholder="Keep blank to auto generate" />
                            </div>
            ...
            <Card>
                <CardContent className="pt-6">
                    ...
                    <div className="space-y-2 mt-4">
                        ...
                        <Textarea id="sell-note" placeholder="Terms & Conditions" />
                    </div>
                </CardContent>
            </Card>
